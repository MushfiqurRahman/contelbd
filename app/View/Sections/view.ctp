...
<div class="related">
	...
	<?php
		$i = 0;
		foreach ($section['Coupon'] as $coupon): ?>
		<tr>
...
<div class="related">
	...
	<?php
		$i = 0;
		foreach ($section['Outlet'] as $outlet): ?>
		<tr>
