...
//                $outletIds = $this->Campaign->Base->find('list', array('conditions' => array('Base.campaign_id' => $this->data['Campaign']['id']),
//                    'fields' => array('Base.outlet_id')));
//            
//            pr($outletIds);
//            
...
//            $this->set('sales', $sales);
                ...
                $outletIds = $this->Campaign->Base->find('list', array('conditions' => array('Base.campaign_id' => $this->request->params['named']['id']),
                    'fields' => array('Base.outlet_id')));
                ...
                $this->paginate = array(
                    'Sale' => array(      
                        ...
                        'contain' => $this->Sale->get_contain_array(),                
                        'conditions' => array('Sale.outlet_id' => $outletIds,
                            'Sale.date_time >=' => $this->request->params['named']['from'],
                            'Sale.date_time <=' => $this->request->params['named']['to']),
                        'group' => 'Sale.outlet_id',
                        'limit' => 1
                    )
                );
